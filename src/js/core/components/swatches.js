  ...
  $.fn.uiSwatches = function (behavior, ...args) {
    ...
    for (let i = 0; i < this.length; i++) {
      ...
      if (Object.prototype.toString.call(behavior) !== "[object String]") {
        ...
        const id =
          definition.id != null ? definition.id : el.getAttribute("id");
        ...
        const selectedIndex =
          definition.selectedIndex != null ? definition.selectedIndex : 0;
