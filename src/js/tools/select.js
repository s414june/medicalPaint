...
class Select_tool_class extends Base_tools_class {
  ...
  mouseup(e) {
    ...
    if (this.resizing) {
      ...
      if (
        this.mousedown_dimensions.x !== x ||
        this.mousedown_dimensions.y !== y ||
        this.mousedown_dimensions.width !== width ||
  ...
  calc_snap(event, pos_x, pos_y) {
    ...
    if (
      min_group_distance.x.end != null &&
      (min_group_distance.x.end < min_distance.x || min_distance.x === null)
    )
    ...
    if (
      min_group_distance.y.end != null &&
      (min_group_distance.y.end < min_distance.y || min_distance.y === null)
    )
